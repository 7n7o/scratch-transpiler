...
spec.GET_VAR = "readVariable";
spec.SET_VAR = "setVar:to:";
spec.CHANGE_VAR = "changeVar:by:";
spec.GET_LIST = "contentsOfList:";
spec.CALL = "call";
spec.PROCEDURE_DEF = "procDef";
spec.GET_PARAM = "getParam";
...
spec.commands = {
    ...
    -- variables
    {"set %m.var to %s",								" ", 9, spec.SET_VAR},
    {"change %m.var by %n",								" ", 9, spec.CHANGE_VAR},
